...
async def _first_resources(dbc, qargs):
	spec = util.Struct(
		...
		first_week = int(qargs.get('first_week', 3)), # TODO: hardcode default to week 0! replace with lookup for user's "current week"
		last_week = int(qargs.get('last_week', 3)), # TODO: see above; lookup user's current-week
